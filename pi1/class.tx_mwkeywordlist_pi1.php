...
class tx_mwkeywordlist_pi1 extends tslib_pibase {
	...
	var $prefixId = 'tx_mwkeywordlist_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_mwkeywordlist_pi1.php';	// Path to this script relative to the extension dir.
	var $extKey = 'mw_keywordlist';	// The extension key.
	var $conf;
	var $pages = Array();
	var $pagesLanguageOverlay = Array();
	var $alphabetNav = Array(); // available chars of active items
	var $iter_num = 0;
	var $pageList;
	...
	/**
	 * Convert Umlauts for proper sorting via a-z header
	 *
	 * @param	string		HTML content for the login form
	 * @return	string		converted umlauts (i.e. ö => oe)
	 * @author		mehrwert <typo3@mehrwert.de>
	 */
	function simplifyString($str) {

		$str = strtolower(trim($str));
		$str = t3lib_cs::specCharsToASCII($str);
	 ...
	 *
	 * @return	string		HTML of the jump menu
	 * @author		mehrwert <typo3@mehrwert.de>
	 */
